...
my personal, minimal setup that embraces the defaults. built to actually get work done.
...
- standard dev tooling such as `nvim`, `podman`, `tmux`, `mise`, and a declarative `nvim` language pack system.
